...
<div class="w-full shadow-lg">
    <div class="mb-3 text-white">
        ...
        <button type="button" id="openModal" class="ml-1.5 bg-yellow-600 hover:bg-yellow-700 px-4 py-2 shadow rounded">
            Import Excel
        </button>
    </div>
            ...
            <tbody>
                ...
                <tr class="hover:bg-grey-lighter text-center">
                    ...
                    <td class="py-4 px-6 border-b border-grey-light">
                        ...
                        <form onsubmit="return confirm('Yakin ?')" class="inline" action="{{ route('delete-skor') }}"
                            method="POST">
                            @csrf
                            @method('delete')
                            <input type="hidden" name="id" value="{{ $skor['id'] }}">
                            <button id="delete" class="px-2.5 py-1.5 bg-red-500 hover:bg-red-600 rounded-md text-white"
                                type="submit">
                                Delete
                            </button>
                        </form>
